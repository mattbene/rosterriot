...
class MbbSingleGameSrefSpider(scrapy.Spider):
    name = "mbb_single_game_sref"
    ...
    start_urls = [
        "https://www.sports-reference.com/cbb/boxscores/2023-11-20-21-chaminade.html",
        ]
    ...
    def parse(self, response):
        ...
        game_data = {
            'game_id': response.url.rsplit('/', 1)[-1].split('.')[0].strip(),
            'team_one': team_one,
            'team_two': team_two,
